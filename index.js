...
favoriteMovie.quote = "So the lion fell in love with the lamb."
//  Print the updated object and run it to test
console.log(favoriteMovie)
...
console.log( "My Favorite movie is " + favoriteMovie.name + ". The movie genre is "+ favoriteMovie.genre + " I give it a " + favoriteMovie.rating + " star rating. A fire quote from the movie is: " + "'"+ favoriteMovie.quote + "'" )
